 ...
 * Check for access token in Authorization header. If Access token is found in the header, delegate authentication to TokenProvider otherwise throw authentication exception
 */
